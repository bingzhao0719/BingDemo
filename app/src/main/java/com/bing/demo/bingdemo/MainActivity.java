...
public class MainActivity extends PageStatusActivity {
...
//        return true;
    ...
    private void initView() {
        ...
        mRecyclerView.setAdapter(new MyAdapter(this, getMessageList()));
    }
    ...
    private List<Message> getMessageList2() {
        List<Message> messageList = new ArrayList<>(11);
        messageList.add(new Message("队长别开枪，是我"));
        messageList.add(new Message("是——你小子", 2));
        messageList.add(new Message("是你老子我"));
    ...
    protected void showContent() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                mStatusManager.showContent();
                mRecyclerView.setAdapter(new MyAdapter(MainActivity.this, getMessageList2()));
            }
        },2000);
    }
}
